...
const TalksPage: NextPage<TalksPageProps> = ({ talks }) => {
  ...
  const talksByYear = groupBy(talks, (talk) =>
    talk.date ? new Date(talk.date).getFullYear() : new Date().getFullYear()
                  ...
                  <TimelineItem key={i}>
                    ...
                    <div className={c('flex', 'flex-wrap', 'gap-x-3', 'font-light')}>
                      ...
                      {talk.event && (
                        <Inline>
                          ...
                          <div>
                            {talk.event_url ? (
                              <Link href={t[talk.event_url] || talk.event_url}>
                    ...
                    {talk.language && (
                      ...
                      >
                        ...
                        <div>{t[talk.language] || talk.language}</div>
                      </div>
                    )}
